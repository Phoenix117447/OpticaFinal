    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="product-card">
                ...
                <form action="productosUsuario.jsp" method="post">
        ...
        <div class="carrito-float" id="carritoFloat">
            ...
            <ul>
                ...
                <li>
                    ...
                    <form action="productosUsuario.jsp" method="post" style="display:inline;">
                        <input type="hidden" name="productoid" value="<%= producto.getProductoid()%>">
            ...
            <form action="factura.jsp" method="post">
                <button type="submit" name="generarFactura" style="margin-top: 10px; background-color: #007bff; color: white;">Generar Factura</button>
            </form>
            <% } else { %>
